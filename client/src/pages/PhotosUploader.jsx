          ...
          addedPhotos.map((link) => (
            <div className="h-32 flex relative" key={link}>
              ...
              <button
                ...
                className="absolute bottom-1 right-1 text-white bg-black p-2 rounded-2xl bg-opacity-40 cursor-pointer"
              >
                <svg
              ...
              <button
                ...
                className="absolute bottom-1 left-1 text-white bg-black p-2 rounded-2xl bg-opacity-40 cursor-pointer"
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
